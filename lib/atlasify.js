...
class Atlasify {
    ...
    load(paths) {
        ...
        exporter_1.Exporter.setExportFormat(this.options.type);
        ...
        Promise.all(loader)
            ...
            this.packer.bins.forEach((bin, index) => {
                ...
                fs_1.default.writeFileSync(`${basename}.json`, exporter_1.Exporter.compile(view));
                console.log('Wrote spritesheet : ' + basename + "." + exporter_1.Exporter.getExtension());
            });
        })
            .catch(err => {
